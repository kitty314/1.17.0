...
GOBUILD=CGO_ENABLED=0 go build -tags with_gvisor -trimpath -ldflags '-X "github.com/kitty314/1.17.0/constant.Version=$(VERSION)" \
		-X "github.com/kitty314/1.17.0/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
